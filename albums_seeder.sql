INSERT INTO albums (artist, album_name, release_year, sales_mil, genre)
VALUES ('Bruce Springsteen', 'Born in the U.S.A.', 1984, 30, 'Heartland Rock');
...
VALUES ('Michael Jackson', 'Thriller', 1982, 51.2, 'Pop, Post-Disco, Funk, Rock'),
        ...
        ('Various Artists', 'Dirty Dancing', 1987, 24.1, 'R&B'),
        ('Celine Dion', 'Falling Into You', 1996, 21.1, 'Pop'),
        ('Adele', '21', 2011, 27.1, 'Soul'),
        ...
        ('Dire Straits', 'Brother in Arms', 1985, 21.1, 'Roots Rock'),
